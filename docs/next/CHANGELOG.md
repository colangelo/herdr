...
- Sidebar agent rows show each pane's open todo count, `τ N`, at the right end of the entry's second row, under the jump label, coloured by the highest open priority; it disappears when nothing is open, and a one-row entry has no room for it.
