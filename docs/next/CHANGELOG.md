...
- The working icon in sidebar agent rows steps a spinner in time with the agent's own terminal-title spinner, riding on title changes Herdr already redraws for instead of a timer; `ui.status_spinner = "off"` keeps it static.
