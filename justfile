...
test:
    ...
    python3 -m unittest scripts.test_agent_detection_manifest_check scripts.test_beta_build_id scripts.test_beta_publish scripts.test_changelog scripts.test_config_reference_check scripts.test_hermes_integration_asset scripts.test_package_windows_conpty scripts.test_preview scripts.test_unix_installer scripts.test_vendor_libghostty_vt scripts.test_vendor_portable_pty scripts.test_windows_cross
